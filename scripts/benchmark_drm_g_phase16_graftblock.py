...
def main() -> int:
    ...
    parser.add_argument("--candidate-learning-rates", nargs="*", type=float, default=None)
    parser.add_argument("--candidate-init-scales", nargs="*", type=float, default=None)
    parser.add_argument("--candidate-activations", nargs="*", default=None)
